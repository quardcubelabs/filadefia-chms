...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ 
    ...
    const inputBaseStyles = 'block w-full rounded-lg sm:rounded-xl border-2 transition-all focus:outline-none text-sm sm:text-base text-gray-900 placeholder:text-gray-500';
    ...
    const inputStateStyles = hasError
      ...
      : 'border-gray-500 hover:border-blue-800 focus:border-blue-800 focus:ring-blue-800 focus:ring-2 focus:outline-none bg-white';
...
export const TextArea = React.forwardRef<HTMLTextAreaElement, TextAreaProps>(
  ({ 
    ...
    const textareaBaseStyles = 'block w-full rounded-xl border-2 px-4 py-3 transition-all focus:outline-none focus:ring-2 text-gray-900 placeholder:text-gray-500 bg-white';
    const textareaStateStyles = hasError
      ? 'border-red-400 focus:border-red-500 focus:ring-red-500'
      : 'border-gray-500 hover:border-blue-800 focus:border-blue-800 focus:ring-blue-800';
